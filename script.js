...
soundDrawStart.volume=.45;
soundRolling.volume=.32;
soundAnnounce.volume=.48;
soundFanfare.volume=.5;

const fixedBallPositions=[
  [18,58],[31,42],[45,59],[58,41],[70,57],[78,43],
  [23,28],[38,24],[53,30],[66,27],[12,43],[82,31],
  [30,68],[46,72],[62,68],[54,49],[38,51],[68,48],
];
...
function generateLottoNumbers(){
  ...
  return {main:pool.slice(0,PICK_COUNT).sort((a,b)=>a-b),bonus:pool[PICK_COUNT]};
}
...
function setupFakeBalls(){
  ...
  for(let i=0;i<IDLE_BALL_COUNT;i++){
    ...
    ball.style.setProperty("--x1",`${randomBetween(-72,72)}px`);
    ball.style.setProperty("--y1",`${randomBetween(-46,46)}px`);
    ball.style.setProperty("--x2",`${randomBetween(-86,86)}px`);
    ball.style.setProperty("--y2",`${randomBetween(-58,58)}px`);
    ball.style.setProperty("--x3",`${randomBetween(-78,78)}px`);
    ball.style.setProperty("--y3",`${randomBetween(-52,52)}px`);
    ball.style.setProperty("--x4",`${randomBetween(-72,72)}px`);
    ball.style.setProperty("--y4",`${randomBetween(-48,48)}px`);
    ball.style.setProperty("--x5",`${randomBetween(-92,92)}px`);
...
function appendResultBall(num,index,isBonus=false){
  ...
  numberList.appendChild(createBall(num,"ball",0));
}
...
function draw(){
  ...
  setTimeout(()=>announceNumbers(result),2000);
}
